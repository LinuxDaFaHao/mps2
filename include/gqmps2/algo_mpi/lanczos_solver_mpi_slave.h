...
*
* Description: GraceQ/MPS2 project. Lanczos solver based on distributed memory parallel, slave side.
*/


#ifndef GQMPS2_ALGO_MPI_LANCZOS_SOLVER_MPI_SLAVE_H
#define GQMPS2_ALGO_MPI_LANCZOS_SOLVER_MPI_SLAVE_H
...
#endif
  RecvBroadCastGQTensor(world, *rpeff_ham[0], kMasterRank);
  RecvBroadCastGQTensor(world, *rpeff_ham[two_site_eff_ham_size-1], kMasterRank);
#ifdef GQMPS_MPI_TIMING_MODE
...
#endif //GQMPS2_ALGO_MPI_LANCZOS_SOLVER_MPI_SLAVE_H
