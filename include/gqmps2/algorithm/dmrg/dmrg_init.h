...
*
* Description: GraceQ/MPS2 project. Initialisation for two-site update finite size DMRG.
*/


#ifndef GQMPS2_ALGORITHM_DMRG_DMRG_INIT_H
#define GQMPS2_ALGORITHM_DMRG_DMRG_INIT_H
...
inline bool NeedGenerateBlockOps(
    const MatReprMPO<GQTensor<TenElemT, QNT>> &,
    const size_t,
    const size_t,
    const std::string &
);
...
#endif //GQMPS2_ALGORITHM_DMRG_DMRG_INIT_H
