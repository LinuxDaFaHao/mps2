...
#ifndef GQMPS2_ALGORITHM_TDVP_TWO_SITE_UPDATE_FINITE_TDVP_IMPL_H
...
std::vector<TenElemT> CalPsi1OpPsi2(
  ...
  WriteGQTensorTOFile(right_boundary_tensor, file);
...
#endif //GQMPS2_ALGORITHM_TDVP_TWO_SITE_UPDATE_FINITE_TDVP_IMPL_H
